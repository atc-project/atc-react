...
- Автоматически сгенерированный [файл в формате Markdown](docs/Response_Actions/RA2202.md)
- Автоматически сгенерированная [mkdocs страница](https://atc-project.github.io/atc-react/Response_Actions/RA2202/)
...
Например [RA**22**02: Collect an email message](docs/Response_Actions/RA2202.md) относится к Стадии **2** (Идентификация) и Категории **2** (Электронная почта).
...
- Автоматически сгенерированный [файл в формате Markdown](docs/Response_Playbooks/RP0001.md)
- Автоматически сгенерированная [mkdocs страница](https://atc-project.github.io/atc-react/Response_Playbooks/RP0001/)
