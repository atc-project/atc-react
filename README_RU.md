...
- Приоритизация разработки техник реагирования на инциденты
- Анализ недочетов — определение "степени покрытия" матрицы RE&CT уже реализованными техниками реагирования на инциденты
