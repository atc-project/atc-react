...
3. [Набор](docs/Response_Playbooks) Сценариев Реагирования на инциденты (Incident Response Playbooks), управляемый сообществом  
...
![](docs/images/react_navigator_export_v3.svg)
...
- Приоритизация задач по созданию и совершенствованию функций реагирования на инциденты, включая развитие компетенций, внедрение технических средств, разработку регламентов и т.д.
