...
Фреймворк создан для накопления, описания и разделения на категории действенных техник реагирования на инциденты.  
...
- Приоритизация разработки действий по реагированию на инциденты
- Анализ недочетов — определение "степени покрытия" матрицы RE&CT уже реализованными действиями по реагированию на инциденты
